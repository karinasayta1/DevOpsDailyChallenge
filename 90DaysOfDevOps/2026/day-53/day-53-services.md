...
**Verify:** Are all 3 pods running? Note down their IP addresses.
   ...
   ![snapshot](images/deployment-yml.png)
...
```
   ...
   ![snapshot](images/Service-yaml.png)
...
```
   ...
   ![snapshot](images/test-pod.png)

   ![snapshot](images/service-commands.png)
...
```
   ...
   ![snapshot](images/3curl.png)
   ![snapshot](images/nslookup.png)
...
```
   ...
   ![snapshot](images/get-services.png)
...
### Your three Service manifests with an explanation of each type
   ...
   * **NodePrt IP**
   ...
   ![snapshot](images/nodeporty.png)

   - Exposes pods externally. Opens a port on every node.
   ...
   * **LoadBalancer**
   ...
   ![snapshot](images/loadbalancery.png)
